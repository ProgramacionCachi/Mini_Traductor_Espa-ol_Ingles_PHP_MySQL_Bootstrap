<html> 
    <head>
        ...
        <title>Traductor Ingles a Español</title>
    </head> 
    <body>
    ...
    ?>
    <hr>
    <center><div class="p-2 mb-2 bg-primary text-white">Traductor de Inglés a Español</div></center><hr>
    ...
    <!--Card--->
            <center><div class="card border-dark mb-3" style="width: 25rem;" >
                <img class="card-img-top" src="./imagenes/Tarjeta_6.jpg" alt="Card image cap">
                <div class="card-body">
                <h5 class="card-title">Traducir de Inglés a Español</h5>
            <form  action="consulta_ingles.php" method="post">
           <!--Palabra en Español a Traducir:<br>-->
                <input type="text" name="palabra_traducir_ingle" style="width : 200px; heigth : 200px" required><br>
                <br>
                <input class="btn btn-success" type="submit" value="Traducir a Español">
            </form>              
        </div>
        </div></center>
    <!--End of the Card-->
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        $traduccion_ingles = $_POST["palabra_traducir_ingle"]; 
        
        $sql = "SELECT * FROM palabras where palabra_english = '$traduccion_ingles'";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<b>La palabra</b> " . $row["palabra_english"]. " ";  
        echo "<b>traducida a español es </b> " . $row["palabra_spanish"]. " <br>";
        echo "<br>";   
    }
    ?>
        </div>
